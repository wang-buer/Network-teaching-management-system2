...
public class JiaoshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiaoshiEntity user = jiaoshiService.selectOne(new EntityWrapper<JiaoshiEntity>().eq("jiaogonghao", username));
    ...
    public R register(@RequestBody JiaoshiEntity jiaoshi){
    	...
    	JiaoshiEntity user = jiaoshiService.selectOne(new EntityWrapper<JiaoshiEntity>().eq("jiaogonghao", jiaoshi.getJiaogonghao()));
		if(user!=null) {
